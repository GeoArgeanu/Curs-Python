'''
Sa se scrie o functie care citeste din fisierul persons.csv si adauga la
datele din acel fisier o lista de date primita ca parametru.
...
class Person:
    ...
    @classmethod  # ofct care este atasata clasei nu obiectlui, in general folosite pt alternative in crearea ob in aceasta clasa
    def from_dict(cls, dct):
        return cls(dct['name'], int(dct['age']), int(dct['height']))

    def to_dict(self):
        return {'name':self, 'age':self, 'height':self}
